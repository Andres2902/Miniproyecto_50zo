 ...
 * @since 2025
 */
public class Game50zoModel extends Observable {
    ...
    /**
     * Constructs a new Game50zoModel with the specified players, deck, and table.
     *
     ...
     */
    public Game50zoModel(Player humanPlayer, int numberOfMachinePlayers, Deck deck, Table table) {

package org.example.cincuentazo.model.machine;
...
public class ThreadMachinePlayer extends Thread {
     ...
     */
    public ThreadMachinePlayer(Player machinePlayer, Game50zoModel game, ImageView tableImageView) {

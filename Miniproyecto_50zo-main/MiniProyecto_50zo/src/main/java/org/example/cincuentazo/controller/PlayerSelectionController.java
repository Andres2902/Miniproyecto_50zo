...
public class PlayerSelectionController {
    ...
    private void startMainGame(int numberOfMachines) throws IOException {
        ...
        Game50zoController mainController = loader.getController();
        mainController.setNumberOfMachinePlayers(numberOfMachines);

        Stage gameStage = new Stage();
        Image appIcon = new Image(getClass().getResourceAsStream("/org/example/cincuentazo/images/Fondo_50ZO.png"));

...
import org.example.cincuentazo.model.deck.Deck;
import org.example.cincuentazo.model.game.Game50zoModel;
import org.example.cincuentazo.model.machine.ThreadMachinePlayer;
import org.example.cincuentazo.model.player.Player;
import org.example.cincuentazo.model.table.Table;
import org.example.cincuentazo.model.exceptions.PlayerEliminatedException;
import org.example.cincuentazo.model.exceptions.InvalidCardException;
 ...
 * @since 2025
 */
public class Game50zoController implements Observer {
    ...
    private Game50zoModel gameModel;
    ...
    private void initializeGame() {
        try {
            ...
            this.gameModel = new Game50zoModel(humanPlayer, numberOfMachinePlayers, deck, table);
    ...
    public void update(Observable o, Object arg) {
        if (o instanceof Game50zoModel && arg instanceof String) {
    ...
    void onHandleExit(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/cincuentazo/player-selection-view.fxml"));
     ...
     */
    public Game50zoModel getGameModel() {
        return gameModel;
    }
